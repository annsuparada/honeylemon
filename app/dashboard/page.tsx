        ...
        <ProtectedPage>
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-gray-600">Overview of your content and audience</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-xs text-gray-500">{stats.activeSubscribers} active</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                <p className="text-sm font-medium text-gray-600">Published (30d)</p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border mb-8">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">Post Status Breakdown</h2>
                    <div className="flex flex-wrap gap-3">
                        ...
                        {stats.pillarCount > 0 && (
                            <span className="badge badge-outline badge-lg px-4 py-3" style={{ backgroundColor: '#9333ea', color: 'white', borderColor: '#9333ea' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border">
                        ...
                        {topPosts.length > 0 ? (
                            ...
                            <p className="text-gray-500 text-center py-8">No published posts with views yet.</p>
                        )}
                    </div>
