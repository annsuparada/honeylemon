                            ...
                            <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary px-6 pb-4">
                                ...
                                <nav className="flex flex-1 flex-col">
                                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                        ...
                                        <li>
                                            <div className="text-xs/6 font-semibold text-white">Your teams</div>
                                            <ul role="list" className="-mx-2 mt-2 space-y-1">
                                                {teams.map((team) => (
                                                    <li key={team.name}>
                                                        ...
                                                        >
                                                            <span className="flex size-6 shrink-0 items-center justify-center rounded-lg border border-blue-400 bg-blue-500 text-[0.625rem] font-medium text-white">
                                                                {team.initial}
                                                            </span>
