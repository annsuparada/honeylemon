...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  const url = `/itineraries/${post.slug}`;
    ...
    <>
            ...
            <div className="mb-4">
              <Breadcrumb
                items={[
                  ...
                  { name: post.title, href: `/itineraries/${post.slug}`, current: true },
                ]}
              />
            </div>
            {/* Blog Header */}
      ...
      <div className="mx-auto py-10 px-4">
        ...
        <BlogSection
          ...
          title="More Itineraries"
          subTitle="Discover more travel itineraries and guides"
          threeColumns={true}
        />
      </div>
    </>
