...
const HeroSection = ({
    ...
    return (
        ...
        >
            ...
            {/* Content */}
            {isSingleBlogPage ? (
                <div data-testid="hero-section" className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center px-4 pt-24 pb-12 sm:pt-32 sm:pb-20">
