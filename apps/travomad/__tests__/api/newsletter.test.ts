...
import { resetJwtConfigCacheForTests, resetNextjsConfigCacheForTests } from '@/lib/config'
...
describe('/api/newsletter', () => {
    beforeAll(() => {
        process.env.SECRET_KEY = process.env.SECRET_KEY || 'test-secret-key-for-newsletter-route-tests-min-32-chars'
        resetJwtConfigCacheForTests()
