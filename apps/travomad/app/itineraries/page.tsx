import { CTA, HeroSection, BlogSection } from "@honeylemon/ui";
...
export const generateMetadata = async (): Promise<Metadata> => {
    return {
        title: "Travel Itineraries for Every Explorer | Honey Lemon",
            ...
            images: [
                {
                    ...
                    width: 1200,
                    height: 630,
                    alt: "Honey Lemon Travel Itineraries - Plan Your Perfect Trip",
                    type: "image/jpeg",
                },
            ],
        },
