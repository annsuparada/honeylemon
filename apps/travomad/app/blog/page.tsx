...
export const generateMetadata = async (): Promise<Metadata> => {
  return {
    title: "Honey Lemon Blog — Real Travel Stories, Smart Tips & Hidden Deals",
    description: "From travel hacks and destination guides to the latest flight deals — the Honey Lemon blog helps smart explorers plan better, travel cheaper, and experience more. No hype, just real-world insight.",
    ...
    openGraph: {
      title: "Honey Lemon Blog — Real Travel Stories, Smart Tips & Hidden Deals",
      description: "Explore expert travel guides, smart tips, and hidden deals. Stay inspired with real travel stories on the Honey Lemon blog.",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Honey Lemon Travel Blog - Expert Travel Guides and Tips",
          type: "image/jpeg",
        },
      ],
    },
