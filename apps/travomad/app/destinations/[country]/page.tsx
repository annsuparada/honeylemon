...
export async function generateMetadata({ params }: { params: { country: string } }): Promise<Metadata> {
    ...
    if (!post) {
        const countryName = params.country
            ...
            .join(' ');
        return {
            title: `${countryName} Travel Guide | Destinations | Honey Lemon`,
    ...
    return {
        ...
        twitter: {
            ...
            title: post.title,
            description: post.description || "Discover travel tips and destination guides on Honey Lemon",
